...
begin
	...
	CREATE TABLE #VentasAp (Territorio  varchar(25), Ventas MONEY, Pais varchar(25));
	...
	begin
		...
		set @sql = N'insert into #VentasAp(Territorio, Ventas, Pais) (select '''+@nom_bd+''' as Territorio, SalesLastYear as "Ventas Año Pasado", Name as País from ' + @servidor + '.' + @nom_bd + '.dbo.'+ @nom_tabla + ' where ' + @condicion+')';
		
		exec sp_executesql @sql
	end 
	select * from #VentasAp;
end
